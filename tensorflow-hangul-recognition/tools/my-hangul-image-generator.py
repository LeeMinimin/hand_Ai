...
MY_FONTS_DIR = os.path.join(SCRIPT_PATH, '../fonts')
MY_OUTPUT_DIR = os.path.join(SCRIPT_PATH, '../image-data')
...
def my_generate_hangul_images(label_file, fonts_dir, output_dir):
    ...
    image_dir = os.path.join(output_dir, 'my-hangul-images')
    ...
    labels_csv = io.open(os.path.join(output_dir, 'my-labels-map.csv'), 'w',
                         encoding='utf-8')
    ...
    for character in labels:
        ...
        for font in fonts:
            ...
            for i in range(DISTORTION_COUNT):
                ...
                distorted_array = my_elastic_distort(
...
def my_elastic_distort(image, alpha, sigma):
    """
...
if __name__ == '__main__':
    ...
    my_generate_hangul_images(args.label_file, args.fonts_dir, args.output_dir)
