...
# My data paths.
MY_LABEL_CSV = os.path.join(SCRIPT_PATH, '../image-data/my-labels-map.csv')
MY_LABEL_FILE = os.path.join(SCRIPT_PATH,
                                  '../labels/한국어 어휘 목록.txt')
MY_OUTPUT_DIR = os.path.join(SCRIPT_PATH, '../my-tfrecords-output')
MY_NUM_SHARDS_TRAIN = 3
MY_NUM_SHARDS_TEST = 1
